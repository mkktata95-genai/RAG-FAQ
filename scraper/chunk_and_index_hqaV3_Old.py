"""
Royal London FAQ - Chunk and Index (v3 — title_questions)
Chunks scraped content, generates HQA-augmented embeddings
plus broad entry-point title_questions, pushes to Azure AI
Search. Targets rlg-faq-index-v3 — rlg-faq-index and
rlg-faq-index-v2 are untouched and remain live.
...
CHUNK_SIZE            = 1600
CHUNK_OVERLAP         = 200
# v5.0.0: default changed to rlg-faq-index-v3. rlg-faq-index and
